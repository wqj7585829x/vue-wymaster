...
export function queryCostAdjustment(FKGX_ZJ) {
  return request({
    url: "/uncollectedFees/queryCostAdjustmentList.do",
    method: "post",
    data: {
      FKGX_ZJ: FKGX_ZJ,
    },
...
export function addCostAdjustment(list) {
  return request({
    url: "/uncollectedFees/saveFeeCollection.do",
    method: "post",
    data: {
      list: JSON.stringify(list),
    },
...
//删除
export function delCostAdjustment(FYSQ_ZJ) {
  return request({
    url: "/uncollectedFees/deleteFeeCollection.do",
    method: "post",
    data: {
      FYSQ_ZJ: FYSQ_ZJ,
    },
