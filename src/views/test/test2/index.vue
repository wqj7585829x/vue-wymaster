<template>
  <div>
    ...
    <p>
      <a
        href="https://github.com/u-leo/umy-ui/blob/master/examples/pages/umycomponent/virtualTreeTableLazy.vue"
        target="_blank"
        >点击查看当前demo页面的代码</a
      >
    </p>
    <p>
      设置 treeConfig里面的lazy 属性为 true 与加载函数 load 。通过指定 row 中的
      hasChildren 字段来指定哪些行是包含子节点。children 与 hasChildren
      都可以通过treeConfig配置
    </p>
    <u-table
      ref="plTreeTable"
...
export default {
  ...
  mounted() {
    ...
    const data2 = Array.from({ length: 20000 }, (_, idx) => ({
      id: idx + "_" + 1,
      date: "2016-05-03",
      name: 1,
      ab: "欢迎使用u-table",
