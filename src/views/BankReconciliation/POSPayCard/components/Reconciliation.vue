      ...
      <div class="dialogtable">
        ...
        <div class="customedetail">
          ...
          <pl-table ref="singleTable" height="250" :data="tableData2" border>
            ...
            <pl-table-column prop="SKMX_SKJE" label="金额（含税）" width="120">
            </pl-table-column>
...
export default {
  ...
  methods: {
    ...
    tabclick() {},
    getReportData(data, subscribeDetailId, subscribeBillId) {
      var date = new Date();
    ...
    gettable() {
      ...
      queryVoucher(data).then((response) => {
    ...
    sure() {
      ...
      confirmTheStone({
        subscribeDetailId: this.subscribeDetailId,
        subscribeBillId: this.subscribeBillId,
        SKPZ_ZJ: SKPZ_ZJ.join(","),
        SKPZ_SKJE: SKPZ_SKJE.join(","),
        code: code.join(","),
      }).then((response) => {
