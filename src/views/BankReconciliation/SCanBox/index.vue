  ...
  <div class="container POSWeChat">
    ...
    <div class="button buttonBox">
      ...
      <el-button
        ...
        v-has="'SCanBoxARRevoke_has'"
      >
        认账撤销</el-button
      >
      <el-button type="success" @click="downloData()" v-has="'SCanBoxExcel_has'"
        >导出excel</el-button
      >
    </div>
    <!-- 按钮end -->
    ...
    <div class="customedetail">
      ...
      >
        ...
        <el-table-column prop="tran_serial_num" label="流水号" width="120">
        </el-table-column>
        <el-table-column prop="tran_type" label="交易类型" width="120">
        </el-table-column>
        <el-table-column prop="counter_code" label="柜台代码" width="120">
        </el-table-column>
        ...
        <el-table-column prop="branch_name" label="柜台名称" width="120">
        </el-table-column>
...
<script>
import {
  queryScanCodeBoxCheck,
  getScanCodeBoxCheckSum,
  confirmCheck,
  cancelCheck,
  queryPayingVoucher,
...
} from "@/api/BankReconciliation/SCanBox";
...
export default {
  ...
  methods: {
    ...
    getTableData() {
      queryScanCodeBoxCheck(this.searchList).then((response) => {
        var data = response.data;
        var key = 0;
        for (var i in data) {
          data[i].tableid = key;
      ...
      getScanCodeBoxCheckSum(this.searchList).then((response) => {
