      ...
      <div class="pngTable">
        ...
        <table width="482" border="0" cellpadding="1" cellspacing="1">
          ...
          <tbody>
            ...
            <tr>
              <td colspan="11">
                <div class="tableBz">{{ formList.PJMX_KPBZ }}</div>
              </td>
            </tr>
          </tbody>
        </table>
...
<script>
import { paperReceiptCoverUpPrintApi } from "@/api/Realtor/TicketList"; //房屋租凭票据列表api
export default {
  data() {
    return {
      formList: {},
...
.elReceiptBgCover {
  ...
  // .skrT{position: absolute;top:428px; right: 120px; }
  .skrT {
    position: absolute;
    top: 424px;
    right: 90px;
