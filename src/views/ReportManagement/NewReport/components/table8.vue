...
import {
  queryAllPayItems,
  queryActualAccountAgentBusiness,
  exportActualAccountAgentBusiness,
...
export default {
  ...
  methods: {
    ...
    getTableData() {
      ...
      queryActualAccountAgentBusiness(data).then((response) => {
    ...
    downloadModel() {
      ...
      exportActualAccountAgentBusiness(data).then((response) => {
        const content = response;
        const blob = new Blob([content]);
        const fileName = `实收款明细报表（代收代付类）.xls`;
