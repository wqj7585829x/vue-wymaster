  ...
  <div class="NewReport">
    ...
    <div class="select" ref="select">
      <el-form label-width="85px">
        <el-row :gutter="30">
          <el-col :span="6">
            <el-form-item label="统计年月:" :rules="[{ required: true }]">
              <el-date-picker
                type="month"
                placeholder=""
                format="yyyy-MM"
                value-format="yyyy_MM"
                v-model="searchList.NY"
              >
              </el-date-picker>
            </el-form-item>
          </el-col>
    ...
    <!-- 搜索框end -->
    <!-- 报表标题 -->
    <div class="ReportTitleDIV"><strong>本期收费率</strong></div>
    <!--  表begin -->
...
export default {
  ...
  methods: {
    ...
    downloadModel() {
      ...
      exportAnnualFeeRateMonth(this.searchList).then((response) => {
        const content = response;
        const blob = new Blob([content]);
        const fileName = `本期收费率.xls`;
