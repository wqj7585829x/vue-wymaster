<template>
  <div class="NewReport">
    ...
    <!-- 报表标题 -->
    <div class="ReportTitleDIV"><strong>应收明细报表</strong></div>
    <!--  表begin -->
...
import {
  queryAllPayItems,
  queryReceivableDetailsReportApi,
  exportApi,
...
export default {
  ...
  methods: {
    ...
    getTableData() {
      ...
      queryReceivableDetailsReportApi(data).then((response) => {
