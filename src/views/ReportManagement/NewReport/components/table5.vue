  ...
  <div class="NewReport">
    ...
    <div style="margin-bottom: 5px">
      <span
        ...
        :key="index"
        >{{ item.FYSQ_SFXMMC }}:{{ item.FYSQ_QSJE }}</span
      >
    </div>
    <!-- 报表标题 -->
    <div class="ReportTitleDIV"><strong>欠收费用明细报表</strong></div>
    <!--  表begin -->
...
export default {
  ...
  methods: {
    ...
    getTableData() {
      ...
      queryArrearsDetailsReportApi(data).then((response) => {
