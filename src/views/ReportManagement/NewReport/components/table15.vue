<template>
  <div class="NewReport">
        ...
        <el-row :gutter="30">
          ...
          <el-col :span="6">
            <el-form-item label="收款方式：">
              <el-select v-model="searchList.SFKM_SKFS" clearable>
                <el-option
          ...
          <el-col :span="6">
            <el-form-item label="收费项目：">
              <el-select v-model="searchList.SFXM_ZJ" clearable>
                <el-option
    ...
    <!-- 搜索框end -->
    <!-- 报表标题 -->
    <div class="ReportTitleDIV"><strong>收款到账明细报表</strong></div>
    <!--  表begin -->
...
export default {
  ...
  methods: {
    ...
    getTableData() {
      queryPayingToAccountDetails(this.searchList).then((response) => {
