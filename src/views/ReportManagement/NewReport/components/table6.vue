<template>
  <div class="NewReport">
    ...
    <!-- 搜索框end -->
    <!-- 报表标题 -->
    <div class="ReportTitleDIV"><strong>实收款明细报表</strong></div>
    <!--  表begin -->
...
import {
  queryAllPayItems,
  queryActualPaymentDetailsReportApi,
  exportApi,
...
export default {
  ...
  methods: {
    ...
    getTableData() {
      ...
      queryActualPaymentDetailsReportApi(data).then((response) => {
