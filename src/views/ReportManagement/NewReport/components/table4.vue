  ...
  <div class="NewReport">
    ...
    <div class="select" ref="select">
      <el-form label-width="85px">
        <el-row :gutter="30">
          ...
          <el-col :span="6">
            <el-form-item label="统计截止实点日期：" label-width="135px">
              <el-date-picker
                type="date"
    ...
    <div style="margin-bottom: 5px">
      <span
        ...
        :key="index"
        >{{ item.FYSQ_SFXMMC }}:{{ item.FYSQ_SSJE }}</span
      >
    </div>
    <!-- 报表标题 -->
    <div class="ReportTitleDIV"><strong>已收款明细报表</strong></div>
    <!--  表begin -->
    ...
    <!--  表 end -->
    <table4Popup :show.sync="show" ref="table4Popup"></table4Popup>
  </div>
</template>
...
import table4Popup from "./table4Popup";
export default {
  data() {
    return {
      tableData: [], //列表参数
  ...
  methods: {
    popupShow(data, name) {
      this.$refs.table4Popup.getPartitionData({
    ...
    getTableData() {
      ...
      queryReceivedDetailsReportApi(data).then((response) => {
