        ...
        <el-row :gutter="30">
          <!-- <el-col :span="6" style="width:300px">
                  <el-form-item label="管理处名称：">
                      <el-select v-model="queryPage.id" placeholder="请选择" @change="PlotChange" clearable>
                        <el-option v-for="item in PlotArray" :key="item.id"  :label="item.GLCNAME" :value="item.id">
                        </el-option>
                      </el-select>
                  </el-form-item>
              </el-col> -->
          ...
          <el-col :span="3">
            <el-form-item label-width="0px">
              <el-button
                type="success"
                @click="search"
                v-has="'ReceivableListSearch_has'"
                >查询</el-button
              >
            </el-form-item>
          </el-col>
...
export default {
  ...
  methods: {
    ...
    cost() {
      ...
      this.$refs.PopChildren.getTableRow({}, 1);
    },
