  ...
  <div class="TicketBill">
    ...
    <section>
      ...
      >
        ...
        <el-table-column label="收清状态" width="100">
          <template slot-scope="scope">
        ...
        <el-table-column
          ...
          width="150"
        ></el-table-column>
        <el-table-column label="票据类型" prop="PJMX_LX" width="150">
          <template slot-scope="scope">
        ...
        <el-table-column
          ...
          width="150"
        ></el-table-column>
        <el-table-column label="是否开票" width="100">
          <template slot-scope="scope">
        ...
        <el-table-column label="增值税信息" prop="SKPZ_SKBS" min-width="100">
          <template slot-scope="scope">
