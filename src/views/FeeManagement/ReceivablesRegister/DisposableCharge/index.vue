  ...
  <div class="DisposableCharge">
    ...
    <div class="standardTable">
      ...
      >
        ...
        <el-table-column prop="YCXSF_TKRQ" label="退款日期" width="150">
        </el-table-column>
  ...
  data() {
    return {
      ...
      configData: [
        ...
        { content: "入帐时间", width: 150, field: "YCXSF_RZSJ" },
        {
          content: "自定义字段1",
          width: 150,
          field: "YCXSF_ZDYZD1",
        ...
        { content: "备注", width: 300, field: "YCXSF_BZ", isShow: false },
      ],
    };
  },
