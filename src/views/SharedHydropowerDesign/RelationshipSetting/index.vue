          ...
          <el-row :gutter="30">
            ...
            <el-col :span="16">
              <el-form-item label="" label-width="0">
                ...
                }}　　分摊项目名称:{{ RelationForm.FTZB_SFXMMC
                }}<br />系数项目名称:{{ RelationForm.FTZB_XSXMMC }}　　表倍率:{{
...
import { queryOrgTreeNoRoom } from "@/api/FeeManagement/AllocationSettings";
import { queryTotalTableDropDownBox } from "@/api/SharedHydropowerDesign/RelationshipSetting";
export default {
  name: "SetRelation",
  data() {
    return {
  ...
  methods: {
    ...
    //关系设定总表查询下拉框
    TotalTableNameAndZJ() {
      queryTotalTableDropDownBox().then((response) => {
