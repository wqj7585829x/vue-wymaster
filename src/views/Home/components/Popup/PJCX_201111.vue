  ...
  <div class="PJCX container" ref="PJCX" id="PJCX">
    ...
    <el-form label-width="75px" :model="pjcxForm" :rules="rules" ref="pjcxForm">
      <el-row :gutter="30">
        ...
        <el-col :span="5" style="width: 400px">
          <el-form-item label="收款方式：" prop="PJMX_SKFS">
            <el-select v-model="pjcxForm.PJMX_SKFS" filterable clearable>
              <el-option
                v-for="item in sfdata"
                :key="item.SFKM_SKFS"
    ...
    <div class="buttonBox">
      ...
      <el-button type="primary" @click="VoidApplication" :disabled="disabledVA"
        >作废申请
      </el-button>
      <el-button
        type="primary"
    ...
    <div class="resoureTable">
      ...
      >
        ...
        <el-table-column prop="PJLYMX_KCY" label="已重用" width="150">
          <template slot-scope="scope">
            <el-checkbox
        ...
        <el-table-column prop="remark" label="不通过理由" width="85">
        </el-table-column>
      ...
      if (Object.keys(this.detailRow).length != 0) {
        if (this.detailRow.PJLYMX_PJZT == "作废") {
          ...
          queryIsMayCancellation({
            ...
            if (response.data.isCanCancellation) {
              this.disabledObsolete = false;
            } else {
              this.disabledObsolete = true;
            }
            if (response.data.isCanApply) {
