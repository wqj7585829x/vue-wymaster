<template>
  <!--票据列表-->
  <div class="ElectronicTicketList">
            ...
            <el-col :span="3" style="width: 0">
              <el-form-item label-width="0px">
                <el-button
                  type="success"
                  @click="submit()"
                  v-has="'ELectronicTicketListQuery_has'"
                  >查询</el-button
                >
              </el-form-item>
            </el-col>
        ...
        <el-row>
          <el-col :span="24">
            <el-button
              ...
              v-has="'ELectronicTicketListPrint_has'"
              >打印
            </el-button>
            <el-button
              type="danger"
              ...
              v-has="'ELectronicTicketListObsolete_has'"
              >作废</el-button
            >
            <el-button
              type="primary"
              ...
              @click="Billreuse"
              v-has="'ELectronicTicketListReuse_has'"
              >票号重用
            </el-button>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    getTableList(val) {
      //列表数据查询
      queryEnBillApi(this.tableParameter).then((response) => {
    ...
    rowClick(row) {
      ...
      this.getListDetail(this.detailRow); //查询选中的收款凭证票据明细
    },
    BillObsoleteClik() {
      //作废
      this.$confirm(
