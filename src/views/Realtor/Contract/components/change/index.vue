        ...
        <el-col :span="4">
          <el-form-item label-width="0px">
            <el-button
              ...
              v-has="'ContractSearchChange_has'"
              >查询</el-button
            >
          </el-form-item>
        </el-col>
...
export default {
  ...
  methods: {
    ...
    getTableData() {
      queryContractChangeMessage(this.contractForm).then((response) => {
    ...
    addcontract() {
      this.show = true;
      this.$refs.contractDialog.getReportData(this.tableRow, 1);
    },
    editcontract() {
      this.show = true;
    },
