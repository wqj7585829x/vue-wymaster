<template>
  <div class="container contract">
    ...
    <!-- 按钮begin -->
    <div class="buttonBox">
      <el-button type="primary" @click="addcontract" :disabled="radio===null" v-has="'ContractDoLive_has'">入住
      </el-button>
      </el-button>
    </div>
    <!-- 按钮end -->
    <div class="resoureTable">
      <el-table ref="multipleTable" :data="tableData" border v-if="maxheight" :max-height="maxheight"
        @row-click="rowClick">
