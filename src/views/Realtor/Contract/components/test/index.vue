<template>
  <div class="container contract">
      ...
      <el-row :gutter="30">
        ...
        <el-col :span="4">
          <el-form-item label-width="0px">
            <el-button type="success" @click="handleCurrentChange(1)" v-has="'ContractSearchTest_has'">查询</el-button>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
    ...
    <!-- 按钮begin -->
    <div class="buttonBox">
      <el-button type="primary" @click="addcontract" :disabled="radio===null" v-has="'ContractDoTest_has'">验收
      </el-button>
      </el-button>
    </div>
    <!-- 按钮end -->
    ...
    <TestDialog :Taxshow.sync="Taxshow" ref="TestDialog" @RefreshItem="handleCurrentChange(1)"></TestDialog>
...
import { queryLeaseContractOfCheckRoom, queryZLPlot } from "@/api/Realtor/Contract";
export default {
  name: "",
  data() {
    return {
  ...
  methods: {
    getTableData() {
      queryLeaseContractOfCheckRoom(this.liveForm).then(response => {
    ...
    addcontract() {
      this.Taxshow = true
      this.$refs.TestDialog.getReportData(this.tableRow, 0);
    },
    deletecontract() {
