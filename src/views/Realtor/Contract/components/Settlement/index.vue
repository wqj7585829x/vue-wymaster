<template>
  <div class="container contract">
      ...
      <el-row :gutter="30">
        ...
        <el-col :span="4">
          <el-form-item label-width="0px">
            <el-button type="success" @click="handleCurrentChange(1)" v-has="'ContractSearchSettlement_has'">查询
            </el-button>
          </el-form-item>
        </el-col>
      </el-row>
    ...
    <!-- 按钮begin -->
    <div class="buttonBox">
      <el-button type="primary" @click="addcontract" :disabled="radio===null" v-has="'ContractDoSettlement_has'">结算
      </el-button>
      </el-button>
    </div>
    <!-- 按钮end -->
    <div class="resoureTable">
      <el-table ref="multipleTable" :data="tableData" border @row-click="rowClick" v-if="maxheight"
        ...
        <el-table-column prop="roomName" label="房间名称" width="120"></el-table-column>
    ...
    <div class="block" v-if="returnTotal>contractForm.pageSize">
      <el-pagination @current-change="handleCurrentChange" :current-page.sync="currentPage"
        :page-size="contractForm.pageSize" layout="total, prev, pager, next, jumper" :total="returnTotal">
      </el-pagination>
    </div>
    <!-- 分页end -->

    <SettlementDialog :Settlementshow.sync="Settlementshow" ref="SettlementDialog" @RefreshItem="RefreshItem">
    </SettlementDialog>
...
import { SqueryContractMessage, deleteContractMessage, updateContractStatusSuccess, updateContractStatusFail, queryZLPlot, submitContract } from "@/api/Realtor/Contract";
...
export default {
  ...
  methods: {
    ...
    getTableData() {
      SqueryContractMessage(this.contractForm).then(response => {
    ...
    addcontract() {
      ...
      this.$refs.SettlementDialog.getReportData(this.tableRow);
    },
    rowClick(row) {
      this.tableRow = row;
