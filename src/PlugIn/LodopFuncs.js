...
export function getLodop(oOBJECT, oEMBED) {
  var strHtmInstall =
    "<br><font color='#FF00FF'><a href='" +
    `${config.BASE_API}/template/install_lodop32.exe` +
    "' target='_self'>打印控件未安装!点击这里执行安装,安装后请刷新页面或重新进入。</a></font>";
  var strHtmUpdate =
    "<br><font color='#FF00FF'><a href='" +
    `${config.BASE_API}/template/install_lodop32.exe` +
    "' target='_self'>打印控件需要升级!点击这里执行升级,升级后请重新进入。</a></font>";
  var strHtm64_Install =
    "<br><font color='#FF00FF'><a href='" +
    `${config.BASE_API}/template/install_lodop64.exe` +
    "' target='_self'>打印控件未安装!点击这里执行安装,安装后请刷新页面或重新进入。</a></font>";
  var strHtm64_Update =
    "<br><font color='#FF00FF'><a href='" +
    `${config.BASE_API}/template/install_lodop64.exe` +
  ...
  var strCLodopInstall_1 =
    "<br><font color='#FF00FF'><a href='" +
    `${config.BASE_API}/template/CLodop_Setup_for_Win32NT.exe` +
    "' target='_self'>Web打印服务CLodop未安装启动，点击这里下载执行安装</a>";
  ...
  var strCLodopUpdate =
    "<br><font color='#FF00FF'><a href='" +
    `${config.BASE_API}/template/CLodop_Setup_for_Win32NT.exe` +
    "' target='_self'>Web打印服务CLodop需升级!点击这里执行升级,升级后请刷新页面。</a></font>";
  var LODOP;
  try {
    var ua = navigator.userAgent;
